...
uartApp_h = AutoGeneratedFile(
    uartApp_template_h, uartApp_h_output, "sc1-data-format/format.json"
)
...
uartApp_cpp_output = "../applications/uartApp.cpp"
uartApp_cpp = AutoGeneratedFile(
    uartApp_template_cpp, uartApp_cpp_output, "sc1-data-format/format.json"
)
